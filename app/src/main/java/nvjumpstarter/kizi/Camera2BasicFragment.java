...
import android.hardware.SensorManager;
import android.os.Bundle;
import nvjumpstarter.kizi.R;

public class Camera2BasicFragment extends Fragment
        implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback, EventListener {
    ...
    //Used for getting orientation
    /**
     * An {@link nvjumpstarter.kizi.SensorLevel} for camera preview.
     */
    private nvjumpstarter.kizi.SensorLevel mSensorLevel;
    ...
    /**
     * An {@link nvjumpstarter.kizi.AutoFitTextureView} for camera preview.
     */
    private nvjumpstarter.kizi.AutoFitTextureView mTextureView;
...
//        SensorManager mSensorManager;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(nvjumpstarter.kizi.R.string.request_permission))
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance(getString(nvjumpstarter.kizi.R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(nvjumpstarter.kizi.R.string.request_permission)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
